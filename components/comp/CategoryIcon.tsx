...
const SHAPES: Record<CategoryName, React.ReactNode> = {
  ...
  Shopping: (
    <>
      <Path d="M6.241 20.682q-.433-.434-.433-1.066t.433-1.067q.434-.433 1.067-.433t1.066.433.434 1.067-.434 1.066-1.066.434-1.067-.434m9.385 0q-.434-.434-.434-1.066t.434-1.067q.434-.433 1.066-.433t1.067.433q.433.434.433 1.067 0 .632-.433 1.066-.434.434-1.067.434t-1.066-.434M5.881 5.5l2.669 5.616h6.635q.173 0 .307-.087.135-.087.231-.24l2.616-4.75q.115-.212.019-.375-.097-.164-.327-.164zm-.489-1h13.02q.651 0 .98.532.33.531.035 1.095l-2.858 5.208q-.217.365-.564.573t-.763.208H8.1l-1.215 2.23q-.154.231-.01.5t.433.27h10.884v1H7.308q-.875 0-1.306-.738t-.021-1.482l1.504-2.68L3.808 3.5H2v-1h2.442zm3.158 6.616h7z" />
    </>
  ),
  ...
  Others: (
    <>
      {/* <Path d="M5 5A5 2 0 1 0 15 5A5 2 0 1 0 5 5" />
      <Path d="M8.2 5A1.8 0.7 0 1 0 11.8 5A1.8 0.7 0 1 0 8.2 5" />
      <Path d="M5 5V16" />
      <Path d="M5 16A5 2 0 0 0 15 16" />
      <Path d="M15 5V9" />
      <Path d="M15 9L17 10L15.6 12L17.5 13.5L16 15.5L18 17.5L15.8 20" /> */}
      <Path
        fill="none"
